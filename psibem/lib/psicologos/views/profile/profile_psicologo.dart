...
class ProfilePsicologo extends StatefulWidget {
  const ProfilePsicologo({super.key});

  @override
  State<ProfilePsicologo> createState() => _ProfilePsicologoState();
}

class _ProfilePsicologoState extends State<ProfilePsicologo> {
      ...
      if (userDoc.exists) {
        ...
        setState(() {
          _userData = {
            ...
            'nome': data['nome'] ?? data['Nome'] ?? '', // Compatibilidade
            'telefone': data['telefone'] ?? '',
            'bio': data['bio'] ?? 'Bio a ser adicionada...', // Bio padrão
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Erro ao atualizar bio: $e')),
                    );
                  }
                } finally {
                  if (mounted) {
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const SettingsPsicologo(),
                          ),
                        );
                      },
                    ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          icon:
                              const Icon(Icons.edit, color: Color(0xFF81C7C6)),
                    ...
                    const SizedBox(height: 16),
                    Text(
                      _userData?['bio'] ?? 'Lorem ipsum dolor sit amet...',
                      style: const TextStyle(
                        color: Colors.black,
                        fontSize: 16,
                        height: 1.5,
